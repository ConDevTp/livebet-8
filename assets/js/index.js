...
function SelectService(obj) {
  var selectteditem = document.getElementsByClassName("selectedServicebox")[0];

  selectteditem.classList.remove("selectedServicebox");
  obj.classList.add("selectedServicebox");
}
// For Blogs
